      ...
      <div className="App">
        <nav>
          ...
          <ul className={menuOpen ? 'show' : ''}>
            ...
            <li><Link to="/events" onClick={toggleMenu}>Billeterie</Link></li>
            <li><Link to="/register" className="register-button" onClick={toggleMenu}>S'inscrire</Link></li>
            <li><Link to="/login" className="login-button" onClick={toggleMenu}>Se connecter</Link></li>
          </ul>
        </nav>
